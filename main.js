...
console.log(sketch);
document.getElementById("yr_sketch").innerHTML = "<p id='con'>Your Sketch - "+sketch+"</p>";
...
function draw() {
    ...
    if (drawn_sketch == sketch) {
        answer_holder = "set";
        score = score+1;
        document.getElementById("ys").innerHTML= "<span id='ys'>Score: " + score+ "</span>";
...
function check_sketch() {
    ...
    document.getElementById("timer").innerHTML= "<span id='timer'>Time: " +time_counter++ + "</span>";
